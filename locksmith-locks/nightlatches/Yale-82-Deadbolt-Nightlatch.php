...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">YALE 82 Deadbolt Nightlatch</h1>

      <!-- Two Columns Layout -->
      <div class="row align-items-center">
        <!-- Product Details -->
        <div class="col-md-7 order-2 order-md-1">
          <p>The <strong>YALE 82 Deadbolt Nightlatch</strong> is a straightforward and reliable security solution designed for situations where a traditional latch isn't necessary. Unlike standard nightlatches, this model features a <strong>deadbolt-only mechanism</strong>—there is no spring latch or intermediate action, making it ideal for doors that require firm, secure locking without auto-latching.</p>

          <p>It is operated by key from the outside and a simple turn handle from the inside. The lock includes <strong>anti-bump protection</strong> and is supplied with a robust 1109 rim cylinder for added peace of mind.</p>

          <p>This model is best suited for internal doors or secondary entry points where solid deadbolt engagement is preferred over quick access latching.</p>

          <ul class="list-unstyled">
            <li><strong>Size:</strong> 60mm Backset</li>
            <li><strong>Features:</strong>
              <ul>
                <li>Deadbolt nightlatch – no spring latch mechanism</li>
                <li>Key operation from the outside</li>
                <li>Turn handle operation from the inside</li>
                <li>No intermediate latching action</li>
                <li>Anti-bump protection built-in</li>
                <li>Supplied with 1109 high-security cylinder</li>
                <li>2 keys included (additional keys: £5 each)</li>
              </ul>
            </li>
            <li><strong>Security Level:</strong> Standard security – suitable for low to moderate risk areas</li>
            <li><strong>Ideal For:</strong> Secondary doors, internal doors, sheds, or garage side doors</li>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Yale-82-Deadbolt-Nightlatch.jpg" class="img-fluid mb-3" alt="YALE 82 Deadbolt Nightlatch" style="max-height: 350px; object-fit: contain;">

          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-82-Deadbolt-Nightlatch.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-82-Deadbolt-Nightlatch1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
