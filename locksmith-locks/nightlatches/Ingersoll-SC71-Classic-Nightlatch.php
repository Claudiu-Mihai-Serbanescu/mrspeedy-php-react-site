...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">Ingersoll SC71/SC73 Ten-Lever Classic Nightlatch</h1>

      <!-- Two Columns Layout -->
      <div class="row align-items-center">
        <!-- Product Details -->
        <div class="col-md-7 order-2 order-md-1">
          <p>The <strong>Ingersoll SC71/SC73 Classic Nightlatch</strong> is a legendary high-security rim lock that has remained largely unchanged for over 40 years. Known for its exceptional build quality and reliability, it continues to be a popular choice for front doors in residential and commercial settings alike.</p>

          <p>This model includes a <strong>10-lever high-security cylinder</strong> as standard, providing outstanding protection against picking and manipulation. The lock features <strong>auto-deadlocking</strong> every time the door is closed, and offers a <strong>double locking function</strong> via key on the SC71 variant for added external security. The SC73 includes the same robust mechanism but without the external double lock feature.</p>

          <p>A convenient <strong>hold-open function</strong> is available using the internal snib. All locks are supplied with a matching cylinder, striker plate, fixings, and 3 high-security keys. Please note, for security purposes, the word “Ingersoll” is no longer embossed on the cylinder casing.</p>
          ...
          <ul class="list-unstyled">
            ...
            <li><strong>Features:</strong>
              <ul>
                <li>10-lever high-security cylinder (standard)</li>
                <li>Auto-deadlocking on door closure</li>
                <li>SC71: Double lock function with external key</li>
                <li>SC73: Classic auto-locking without double locking</li>
                <li>Hold-open snib function on interior</li>
                <li>Includes cylinder, lock case, staple/strike plate, and all fixings</li>
                <li>100% Genuine Ingersoll product – beware of imitations</li>
                <li>3 keys supplied (extra keys £14.50 each)</li>
              </ul>
            </li>

            <li><strong>Security Level:</strong> High security – suitable for external entrance doors</li>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Ingersoll-SC71-Classic-Nightlatch.jpg" class="img-fluid mb-3" alt="Ingersoll SC71 Nightlatch" style="max-height: 350px; object-fit: contain;">

          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Ingersoll-SC71-Classic-Nightlatch.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Ingersoll-SC71-Classic-Nightlatch1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
