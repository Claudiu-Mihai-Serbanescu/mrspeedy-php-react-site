...
<body id="page-top">
    ...
    <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
        <div class="container">
            <!-- Product Title -->
            <h1 class="text-center">YALE BS3/BS4 - BS8621 Emergency Escape Nightlatch</h1>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-7 order-2 order-md-1">
                    <ul class="list-unstyled">
                        <li><strong>Description:</strong> Yale British Standard Nightlatches offer the maximum level of protection against known attack methods.</li>

                        <li><strong>Sizes:</strong>
                            <ul>
                                <li>BS3 - 60mm Backset</li>
                                <li>BS4 - 40mm Backset</li>
                            </ul>
                        </li>

                        <li><strong>Finishes/Colours:</strong>
                            <ul>
                                <li>Polished Brass</li>
                                <li>Polished Chrome (60mm Backset only)</li>
                            </ul>
                        </li>

                        <li><strong>Features:</strong>
                            <ul>
                                <li>Internal handle cannot be locked from the inside allowing for ease of escape in case of emergency</li>
                                <li>20mm anti-saw bolt for increased strength</li>
                                <li>Supplied with high security TS007 1* 6 pin rim cylinder</li>
                                <li>Anti-drill</li>
                                <li>Anti-pick</li>
                                <li>Anti-bump</li>
                                <li>Anti-carding protection</li>
                                <li>Automatic deadlocking</li>
                                <li>Snib to deadlock and hold back the latch</li>
                            </ul>
                        </li>
                        ...
                        <li><strong>Standards & Endorsements:</strong>
                            <ul>
                                <li>Kitemarked to BS8621:2007 KM21358</li>
                                <li>Complies to BS EN 12209:2003 & BS EN 1303:2005</li>
                                <li>CE marked</li>
                                <li>Secured by Design approved - recommended by the Police</li>
                ...
                <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
                    <!-- Imaginea principală -->
                    <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Yale-BS3-BS4-Emergency-Escape-Nightlatch.jpg" class="img-fluid mb-3" alt="YALE BS3/BS4 Nightlatch" style="max-height: 350px; object-fit: contain;">

                    <!-- Galerie imagini mici -->
                    <div class="d-flex justify-content-center gap-2 flex-wrap">
                        <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-BS3-BS4-Emergency-Escape-Nightlatch.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
                        <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-BS3-BS4-Emergency-Escape-Nightlatch1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
                    </div>
                </div>
            </div>
        </div>
