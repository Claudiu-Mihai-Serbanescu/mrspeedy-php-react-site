...
<body id="page-top">
    ...
    <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
        <div class="container">
            <!-- Product Title -->
            <h1 class="text-center">YALE P1/P2 Double Locking Nightlatch</h1>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-7 order-2 order-md-1">
                    <ul class="list-unstyled">
                        <li><strong>Description:</strong> High security double locking nightlatch with internal lockable handle and automatic deadlocking.</li>

                        <li><strong>Sizes:</strong>
                            <ul>
                                <li>P1 - 60mm Backset</li>
                                <li>P2 - 40mm Backset</li>
                            </ul>
                        </li>
                        ...
                        <li><strong>Keys Supplied:</strong> 2 (extra keys £5 each)</li>

                        <li><strong>Security Level:</strong> High security</li>
                    </ul>
                </div>
                ...
                <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
                    <!-- Imaginea principală -->
                    <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Yale-P1-P2-Double-Locking-Nightlatch.jpg" class="img-fluid mb-3" alt="YALE P1/P2 Nightlatch" style="max-height: 350px; object-fit: contain;">

                    <!-- Galerie imagini mici -->
                    <div class="d-flex justify-content-center gap-2 flex-wrap">
                        <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-P1-P2-Double-Locking-Nightlatch.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
                        <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-P1-P2-Double-Locking-Nightlatch1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
                    </div>
                </div>
            </div>
        </div>
