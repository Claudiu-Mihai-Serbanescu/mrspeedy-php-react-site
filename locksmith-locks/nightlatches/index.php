    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <?php
                $categories = [
                    ["name" => "BS1/BS2 - BS3621 Maximum Security Nightlatch", "slug" => "Yale-BS1-BS2-Maximum-Security-Nightlatch"],
                    ["name" => "YALE BS3/BS4 - BS8621 Emergency Escape Nightlatch", "slug" => "Yale-BS3-BS4-Emergency-Escape-Nightlatch"],
                    ["name" => "YALE P1/P2 Double Locking Nightlatch", "slug" => "Yale-P1-P2-Double-Locking-Nightlatch"],
                    ["name" => "YALE 85/89 Deadlocking Nightlatch", "slug" => "Yale-85-89-Deadlocking-Nightlatch"],
                    ["name" => "YALE 77 Traditional Nightlatch", "slug" => "Yale-77-Traditional-Nightlatch"],
                    ["name" => "YALE 706 Traditional Nightlatch", "slug" => "Yale-706-Traditional-Nightlatch"],
                    ["name" => "YALE Y3 Contemporary Nightlatch", "slug" => "Yale-Y3-Contemporary-Nightlatch"],
                    ["name" => "YALE 81 Rollerbolt Nightlatch", "slug" => "Yale-81-Rollerbolt-Nightlatch"],
                    ["name" => "Yale-82-Deadbolt-Nightlatch", "slug" => "Yale-82-Deadbolt-Nightlatch"],
                    ["name" => "Yale-84-88-Standard-Nightlatch", "slug" => "Yale-84-88-Standard-Nightlatch"],
                    ["name" => "Yale-91-Basic-Nightlatch", "slug" => "Yale-91-Basic-Nightlatch"],
                    ["name" => "Union-1332-Drawback-Lock", "slug" => "Union-1332-Drawback-Lock"],
                    ["name" => "Union-1334-Drawback-Lock", "slug" => "Union-1334-Drawback-Lock"],
                    ["name" => "Union-4L67E-Rim-Lock", "slug" => "Union-4L67E-Rim-Lock"],
                    ["name" => "ERA-BS3621-High-Security-Nightlatch", "slug" => "ERA-BS3621-High-Security-Nightlatch"],
                    ["name" => "ERA-BS8621-Keyless-Egress-Nightlatch", "slug" => "ERA-BS8621-Keyless-Egress-Nightlatch"],
                    ["name" => "Banham-L2000-Rim-Deadbolt", "slug" => "Banham-L2000-Rim-Deadbolt"],
                    ["name" => "Banham-EL4000-Rim-Deadbolt", "slug" => "Banham-EL4000-Rim-Deadbolt"],
                    ["name" => "Ingersoll-SC71-Classic-Nightlatch", "slug" => "Ingersoll-SC71-Classic-Nightlatch"],
                    ["name" => "Ingersoll-SC73E-Communal-Nightlatch", "slug" => "Ingersoll-SC73E-Communal-Nightlatch"],
                ...
                foreach ($categories as $cat):
                    ...
                    $link = "https://mrspeedy.co.uk/locksmith-locks/nightlatches/" . $cat['slug'] . ".php";
                ?>
