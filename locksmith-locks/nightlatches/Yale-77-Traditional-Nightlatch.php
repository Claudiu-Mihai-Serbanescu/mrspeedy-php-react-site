...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">YALE 77 Traditional Nightlatch</h1>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-7 order-2 order-md-1">
          <ul class="list-unstyled">
            <li><strong>Description:</strong> The original Yale Lock</li>
            ...
            <li><strong>Finishes/Colours:</strong>
              <ul>
                ...
                <li>Yale 'Green' with Brass or Chrome cylinder</li>
              </ul>
            </li>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <!-- Imaginea principală -->
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Yale-77-Traditional-Nightlatch.jpg" class="img-fluid mb-3" alt="YALE 77 Traditional Nightlatch" style="max-height: 350px; object-fit: contain;">

          <!-- Galerie imagini mici -->
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-77-Traditional-Nightlatch.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-77-Traditional-Nightlatch1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
