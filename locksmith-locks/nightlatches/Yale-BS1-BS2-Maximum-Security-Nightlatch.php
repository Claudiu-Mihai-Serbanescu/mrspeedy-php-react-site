...
<body id="page-top">
    ...
    <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
        <div class="container">
            <!-- Product Title -->
            <h1 class="text-center">YALE BS1/BS2 - BS3621 Maximum Security Nightlatch</h1>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-7 order-2 order-md-1">
                    <ul class="list-unstyled">
                        ...
                        <li><strong>Sizes:</strong>
                            <ul>
                                <li>BS1 - 60mm Backset</li>
                                <li>BS2 - 40mm Backset</li>
                            </ul>
                        </li>
                        ...
                        <li><strong>Features:</strong>
                            <ul>
                                ...
                                <li>Internal lockable handle</li>
                                <li>Automatic deadlocking</li>
                                <li>Push button to hold back the latch</li>
                            </ul>
                        </li>
                        ...
                        <li><strong>Standards & Endorsements:</strong>
                            <ul>
                                <li>Kitemarked to BS3621:2007 KM21358</li>
                ...
                <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
                    <!-- Imaginea principală -->
                    <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Yale-BS1-BS2-Maximum-Security-Nightlatch.jpg" class="img-fluid mb-3" alt="YALE BS1/BS2 Nightlatch" style="max-height: 350px; object-fit: contain;">

                    <!-- Galerie imagini mici -->
                    <div class="d-flex justify-content-center gap-2 flex-wrap">
                        <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-BS1-BS2-Maximum-Security-Nightlatch.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
                        <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-BS1-BS2-Maximum-Security-Nightlatch1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
                    </div>
                </div>
            </div>
        </div>
