...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">YALE 91 Basic Security Nightlatch</h1>

      <!-- Two Columns Layout -->
      <div class="row align-items-center">
        <!-- Product Details -->
        <div class="col-md-7 order-2 order-md-1">
          <p>The <strong>YALE 91 Basic Security Nightlatch</strong> is a simple and practical solution for internal doors or shared access properties that do not require deadlocking. Ideal for hotels, hostels, or institutional settings, this lock allows controlled entry while ensuring quick and safe egress from inside.</p>

          <p>It features a <strong>non-deadlocking mechanism</strong> that permits the latch to be held back using the snib, but does not allow it to be locked externally—making it safer for environments where fast exit is a priority. The lock is supplied with a <strong>reliable 1109 cylinder</strong> and includes basic <strong>anti-bump protection</strong>.</p>

          <ul class="list-unstyled">
            <li><strong>Size:</strong> 60mm Backset</li>
            <li><strong>Finishes:</strong> Plain grey body with your choice of:
              <ul>
                <li>Polished Brass cylinder</li>
                <li>Polished Chrome cylinder</li>
              </ul>
            </li>
            <li><strong>Features:</strong>
              <ul>
                <li>Non-deadlocking nightlatch – ideal for shared buildings or institutions</li>
                <li>Snib holds the latch in the withdrawn position only</li>
                <li>Anti-bump protected</li>
                <li>Supplied with YALE 1109 cylinder</li>
                <li>2 keys included (extra keys available at £5 each)</li>
              </ul>
            </li>
            <li><strong>Security Level:</strong> Standard security – suitable for internal and communal doors</li>
            <li><strong>Best Use:</strong> Hotels, hostels, schools, offices, and non-deadlocking environments</li>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Yale-91-Basic-Nightlatch.jpg" class="img-fluid mb-3" alt="YALE 91 Basic Security Nightlatch" style="max-height: 350px; object-fit: contain;">

          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-91-Basic-Nightlatch.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-91-Basic-Nightlatch1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
