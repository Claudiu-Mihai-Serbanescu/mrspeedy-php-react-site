...
<body id="page-top">
    ...
    <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
        <div class="container">
            <!-- Product Title -->
            <h1 class="text-center">YALE 81 Rollerbolt Nightlatch</h1>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-7 order-2 order-md-1">
                    <ul class="list-unstyled">
                        <li><strong>Description:</strong> Rollerbolt nightlatch with push/pull operation</li>

                        <li><strong>Size:</strong> 60mm Backset</li>

                        <li><strong>Features:</strong>
                            <ul>
                                <li>Nightlatch with rollerbolt for push/pull action</li>
                                <li>Prevents accidental lock out</li>
                                <li>Ideal for flat and communal entrance doors</li>
                                <li>Key operation from outside</li>
                                <li>Turn handle operation from inside</li>
                                <li>Anti-bump</li>
                ...
                <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
                    <!-- Imaginea principală -->
                    <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Yale-81-Rollerbolt-Nightlatch.jpg" class="img-fluid mb-3" alt="YALE 81 Rollerbolt Nightlatch" style="max-height: 350px; object-fit: contain;">

                    <!-- Galerie imagini mici -->
                    <div class="d-flex justify-content-center gap-2 flex-wrap">
                        <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-81-Rollerbolt-Nightlatch.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
                    </div>
                </div>
            </div>
        </div>
