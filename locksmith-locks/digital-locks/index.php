...
-->
    <section class="py-5">
        <div class="container">
            <h2 class="text-center mb-5">Explore Our Digital Locks</h2>
            <div class="row g-4">

                <?php
                $categories = [
                    ["name" => "Budget-Digital-Lock", "slug" => "Budget-Digital-Lock"],
                    ["name" => "Heavy-Duty-Digital-Lock", "slug" => "Heavy-Duty-Digital-Lock"],
                    ["name" => "Superior-Digital-Lock", "slug" => "Superior-Digital-Lock"],
                    ["name" => "Ultimate-Digital-Door-Lock", "slug" => "Ultimate-Digital-Door-Lock"],
                ...
                foreach ($categories as $cat):
                    ...
                    $link = "https://mrspeedy.co.uk/locksmith-locks/digital-locks/" . $cat['slug'] . ".php";
                ?>
