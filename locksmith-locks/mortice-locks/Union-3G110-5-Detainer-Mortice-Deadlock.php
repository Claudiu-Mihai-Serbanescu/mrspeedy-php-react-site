...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">Union 3G110 - 5 Detainer Mortice Deadlock</h1>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-7 order-2 order-md-1">
          <ul class="list-unstyled">
            <li><strong>Size:</strong> 44mm Backset</li>
            ...
            <li><strong>Features:</strong>
              <ul>
                ...
                <li>Deadbolt is locked or unlocked by key from either side</li>
                ...
                <li>14mm bolt throw</li>
                <li>Can be supplied on patented RKS key section to prevent illicit copying</li>
                <li>Case Size: 73mm</li>
                <li>Case: Silver powder coat</li>
                <li>Rebate Kit: B-3G110R (13mm, left or right handed)</li>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <!-- Imaginea principală -->
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Union-3G110-5-Detainer-Mortice-Deadlock.jpg" class="img-fluid mb-3" alt="Union 3G110 Detainer Deadlock" style="max-height: 350px; object-fit: contain;">

          <!-- Galerie imagini mici -->
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Union-3G110-5-Detainer-Mortice-Deadlock.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Union-3G110-5-Detainer-Mortice-Deadlock1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
