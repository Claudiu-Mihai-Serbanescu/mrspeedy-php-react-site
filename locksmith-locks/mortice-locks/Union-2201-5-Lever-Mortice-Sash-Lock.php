...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">Union 2201 - 5 Lever Mortice Sash Lock</h1>
      ...
      <div class="row align-items-center">
          ...
          <ul class="list-unstyled">
            ...
            <li><strong>Features:</strong>
              <ul>
                ...
                <li>Rebate Kit: 2989 (13, 19 or 25mm sizes)</li>
                <li>Keying Groups: May be supplied to pass or differ</li>
                <li><strong>Keying:</strong> 600 standard differs (keys are not numbered for security purposes)</li>
              </ul>
            </li>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <!-- Imaginea principală -->
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Union-2201-5-Lever-Mortice-Sash-Lock.jpg" class="img-fluid mb-3" alt="Union 2201 Sash Lock" style="max-height: 350px; object-fit: contain;">

          <!-- Galerie imagini mici -->
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Union-2201-5-Lever-Mortice-Sash-Lock.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Union-2201-5-Lever-Mortice-Sash-Lock1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
