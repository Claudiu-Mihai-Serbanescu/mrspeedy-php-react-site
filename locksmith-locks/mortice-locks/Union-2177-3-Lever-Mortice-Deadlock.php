...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">Union 2177 - 3 Lever Mortice Deadlock</h1>
      ...
      <div class="row align-items-center">
          ...
          <ul class="list-unstyled">
            ...
            <li><strong>Features:</strong>
              <ul>
                ...
                <li>May be keyed alike with 2077 and 2277</li>
                ...
                <li>Rebate Kit: 2969 (13mm, 19mm or 25mm)</li>
                <li>Keying Groups: May be supplied to pass, differ and keyed alike with 2077, and 2277</li>
                <li>Keying: May be supplied to differ or to pass</li>
              </ul>
            </li>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <!-- Imaginea principală -->
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Union-2177-3-Lever-Mortice-Deadlock.jpg" class="img-fluid mb-3" alt="Union 2177 Deadlock" style="max-height: 350px; object-fit: contain;">

          <!-- Galerie imagini mici -->
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Union-2177-3-Lever-Mortice-Deadlock.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Union-2177-3-Lever-Mortice-Deadlock1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
