...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">Union 2101 - 5 Lever Deadlock</h1>
      ...
      <div class="row align-items-center">
          ...
          <ul class="list-unstyled">
            ...
            <li><strong>Features:</strong>
              <ul>
                ...
                <li>May be keyed alike with 2201</li>
                ...
                <li>Rebate Kit: 2988 (13, 19 or 25mm sizes)</li>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <!-- Imaginea principală -->
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Union-2101-5-Lever-Deadlock.jpg" class="img-fluid mb-3" alt="Union 2101 5 Lever Deadlock" style="max-height: 350px; object-fit: contain;">

          <!-- Galerie imagini mici -->
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Union-2101-5-Lever-Deadlock.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Union-2101-5-Lever-Deadlock1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
