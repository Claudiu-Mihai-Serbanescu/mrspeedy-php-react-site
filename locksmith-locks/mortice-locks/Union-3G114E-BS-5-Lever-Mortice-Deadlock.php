...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">Union 3G114E - 5 Lever BS 3621:2007 Mortice Deadlock</h1>
      ...
      <div class="row align-items-center">
          ...
          <ul class="list-unstyled">
            ...
            <li><strong>Features:</strong>
              <ul>
                ...
                <li>Can be supplied with either a single or double pole microswitch for alarm systems</li>
                <li>Supplied with one plain escutcheon and one escutcheon with a cover plate, finished to match the faceplate/strike</li>
                ...
                <li>Rebate Kit: B-3G114R (13, 19 or 25mm sizes)</li>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <!-- Imaginea principală -->
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Union-3G114E-BS-5-Lever-Mortice-Deadlock.jpg" class="img-fluid mb-3" alt="Union 3G114E Mortice Deadlock" style="max-height: 350px; object-fit: contain;">

          <!-- Galerie imagini mici -->
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Union-3G114E-BS-5-Lever-Mortice-Deadlock.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Union-3G114E-BS-5-Lever-Mortice-Deadlock1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
