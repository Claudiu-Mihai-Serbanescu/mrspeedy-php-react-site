...
-->
    <section class="py-5">
        <div class="container">
            <h2 class="text-center mb-5">Explore Our Mortice Locks</h2>
            <div class="row g-4">

                <?php
                $categories = [
                    ["name" => "Banham-M2003-Thumbturn-Deadlock", "slug" => "Banham-M2003-Thumbturn-Deadlock"],
                    ["name" => "Ingersoll-SC110-Hookbolt", "slug" => "Ingersoll-SC110-Hookbolt"],
                    ["name" => "Banham-M7-Mortice-Deadlock", "slug" => "Banham-M7-Mortice-Deadlock"],
                    ["name"=> "Bedroom-Door-Lock", "slug" => "Bedroom-Door-Lock"],
                    ["name"=> "Thumb-Turn-Mortice-Lock", "slug" => "Thumb-Turn-Mortice-Lock"],
                    ["name" => "Union 2177 - 3 Lever Mortice Deadlock", "slug" => "Union-2177-3-Lever-Mortice-Deadlock"],
                    ["name" => "Union-3G110-5-Detainer-Mortice-Deadlock", "slug" => "Union-3G110-5-Detainer-Mortice-Deadlock"],
                    ["name" => "Union-3G114E-BS-5-Lever-Mortice-Deadlock", "slug" => "Union-3G114E-BS-5-Lever-Mortice-Deadlock"],
                    ["name" => "Union-3K74E-BS-5-Lever-Mortice-Sashlock", "slug" => "Union-3K74E-BS-5-Lever-Mortice-Sashlock"],
                    ["name" => "Union-3R35-3R35X-5-Detainer-Deadlocking-Latch", "slug" => "Union-3R35-3R35X-5-Detainer-Deadlocking-Latch"],
                    ["name" => "Union-2077-3-Lever-Horizontal-Mortice-Sash-Lock", "slug" => "Union-2077-3-Lever-Horizontal-Mortice-Sash-Lock"],
                    ["name" => "Union-2101-5-Lever-Deadlock", "slug" => "Union-2101-5-Lever-Deadlock"],
                    ["name" => "Union-2134E-BS-5-Lever-Deadlock", "slug" => "Union-2134E-BS-5-Lever-Deadlock"],
                    ["name" => "Union-2277-3-Lever-Mortice-Sash-Lock", "slug" => "Union-2277-3-Lever-Mortice-Sash-Lock"],
                    ["name" => "Union-2201-5-Lever-Mortice-Sash-Lock", "slug" => "Union-2201-5-Lever-Mortice-Sash-Lock"],
                    ["name" => "Union-2234E-BS-5-Lever-Mortice-Sash-Lock", "slug" => "Union-2234E-BS-5-Lever-Mortice-Sash-Lock"],
                    ["name" => "ERA-Fortress-5-Lever-Deadbolt", "slug" => "ERA-Fortress-5-Lever-Deadbolt"],
                    ["name" => "ERA-Fortress-5-Lever-Sashbolt", "slug" => "ERA-Fortress-5-Lever-Sashbolt"],
                    ["name" => "Banham-M2002-Mortice-Deadlock", "slug" => "Banham-M2002-Mortice-Deadlock"],
                ...
                foreach ($categories as $cat):
                    ...
                    $link = "https://mrspeedy.co.uk/locksmith-locks/mortice-locks/" . $cat['slug'] . ".php";
                ?>
