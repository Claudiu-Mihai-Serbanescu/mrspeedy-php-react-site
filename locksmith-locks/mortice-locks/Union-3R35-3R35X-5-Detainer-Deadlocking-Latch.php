...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">Union 3R35 / 3R35X - 5 Detainer Deadlocking Latch</h1>
      ...
      <div class="row align-items-center">
          ...
          <ul class="list-unstyled">
            ...
            <li><strong>Features:</strong>
              <ul>
                ...
                <li>For timber door hinged on the left or the right</li>
                <li>Keys are suitable for use on doors up to 50mm thick</li>
                <li>Detainer style locks provide a higher number of key combinations than lever locks</li>
                <li><strong>3R35X:</strong> suitable for use on escape doors</li>
                <li>For use with handles ref 3R35F</li>
                <li>Handles can be secured from both sides</li>
                <li>When closed, the door is secured by an automatic deadlocking action on the latch</li>
                <li>A hold back snib can be used to keep the latch in the withdrawn position</li>
                <li><strong>3R35X:</strong> as the 3R35 but the inside handle cannot be locked allowing free egress at all times</li>
                <li>Force resistant, anti-pick and anti-saw security features</li>
                <li>Available with square forend and striking plate</li>
                <li>10mm latch bolt throw</li>
                <li><strong>3R35 only:</strong> can be supplied on patented RKS key section to prevent illicit copying</li>
                <li>Case Size: 80mm</li>
                <li>Centres: 56mm</li>
                <li>Case: Silver powder coat</li>
                <li>Latch Bolt: Sintered iron</li>
                <li>Follower: Sintered iron</li>
                <li>Locks are handed – please state required handing when ordering</li>
                <li>Rebate Kit: B-3R35R (13mm, left or right handed)</li>
                <li>Keying Groups: Standard differ, to pass or masterkeyable with other detainer locks</li>
              </ul>
            </li>

            <li><strong>Keys Supplied:</strong> 2 (extra keys £7 each)</li>
          </ul>
        </div>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <!-- Imaginea principală -->
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Union-3R35-3R35X-5-Detainer-Deadlocking-Latch.jpg" class="img-fluid mb-3" alt="Union 3R35 Deadlocking Latch" style="max-height: 350px; object-fit: contain;">

          <!-- Galerie imagini mici -->
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Union-3R35-3R35X-5-Detainer-Deadlocking-Latch.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Union-3R35-3R35X-5-Detainer-Deadlocking-Latch1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
