...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">Union 2077 - 3 Lever Horizontal Mortice Sash Lock</h1>
      ...
      <div class="row align-items-center">
          ...
          <ul class="list-unstyled">
            ...
            <li><strong>Features:</strong>
              <ul>
                ...
                <li>Latch bolt withdrawn by knob or sprung lever handle from either side</li>
                <li>Two way action, suitable for knobs or sprung lever handles</li>
                <li>May be keyed alike with 2177 and 2277</li>
                ...
                <li>Case Size: 124mm (5") or 149mm (6")</li>
                <li>Case: Steel, silver powder coat</li>
                <li>Deadbolt: Brass, with hardened steel rollers</li>
                <li>Latch Bolt: Brass, easily reversible</li>
                <li>Follower: 8mm square. Two way action</li>
                <li>Rebate Kit: 2939 (13mm, 19mm or 25mm)</li>
                <li>Keying Groups: May be supplied to pass, differ and keyed alike with 2277 and 2177</li>
                <li><strong>Keying:</strong> 100 standard differs (numbers M101M - M200M)</li>
              </ul>
            </li>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <!-- Imaginea principală -->
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Union-2077-3-Lever-Horizontal-Mortice-Sash-Lock.jpg" class="img-fluid mb-3" alt="Union 2077 Sash Lock" style="max-height: 350px; object-fit: contain;">

          <!-- Galerie imagini mici -->
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Union-2077-3-Lever-Horizontal-Mortice-Sash-Lock.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Union-2077-3-Lever-Horizontal-Mortice-Sash-Lock1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
