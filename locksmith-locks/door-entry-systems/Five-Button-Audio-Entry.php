...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">Five Button Audio Entry System</h1>

      <!-- Two Columns Layout -->
      <div class="row align-items-center">
        <!-- Product Details -->
        <div class="col-md-7 order-2 order-md-1">
          <p>The <strong>Videx Five Button Audio Entry System</strong> is a robust and modern access control solution ideal for small apartment buildings, office units, or multi-tenant residential conversions with up to five separate dwellings or spaces. Videx is a leading brand known for providing high-quality audio and video entry systems with reliable long-term performance.</p>

          <p>This complete system includes a weatherproof aluminium door station with five call buttons, five internal white gloss handsets, a mains power transformer, and all necessary wiring. During installation, any existing wiring from a previous system is tested and reused where appropriate, preserving aesthetics and reducing installation time.</p>

          <p>The system connects to your current electric strike/release (subject to suitability), and for full access control we recommend the optional <strong>CISA electro-mechanical communal door lock</strong> (sold separately).</p>

          <ul class="list-unstyled">
            <li><strong>What’s Included:</strong>
              <ul>
                <li>Exterior aluminium door station with 5 call buttons</li>
                <li>Five internal white gloss plastic handsets</li>
                <li>Mains power transformer</li>
                <li>All necessary wiring (new or reused after testing)</li>
                <li>Connection to existing electric release if compatible</li>
                <li>Professional installation included</li>
              </ul>
            </li>

            <li><strong>Recommended Add-On:</strong> CISA Electro-Mechanical Lock (not included)</li>
            <li><strong>Finish:</strong> Brushed aluminium exterior, white gloss interior handsets</li>
            <li><strong>Installation Area:</strong> Available throughout Birmingham and surrounding areas</li>
          </ul>
        </div>

        <!-- Product Image -->
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Five-Button-Audio-Entry.jpg" class="img-fluid mb-3" alt="Five Button Audio Entry System" style="max-height: 350px; object-fit: contain;">

          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Five-Button-Audio-Entry.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Five-Button-Audio-Entry1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
