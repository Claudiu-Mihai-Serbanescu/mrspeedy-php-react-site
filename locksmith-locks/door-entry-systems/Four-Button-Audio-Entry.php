...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">Four Button Audio Entry System</h1>

      <!-- Two Columns Layout -->
      <div class="row align-items-center">
        <!-- Product Details -->
        <div class="col-md-7 order-2 order-md-1">
          <p>The <strong>Videx Four Button Audio Entry System</strong> is a robust and elegant entry solution designed for small apartment buildings, converted houses, or mixed-use premises with up to four separate units. Known for their superior build quality, Videx systems are a trusted choice for long-term access control.</p>

          <p>This package includes a durable aluminium door station with four call buttons, four white gloss internal handsets, a mains power supply, and all required wiring. During upgrades, existing cabling is tested and reused wherever possible to reduce installation time and maintain a clean, professional look.</p>

          <p>The system is compatible with most standard electric release locks (tested on-site during installation). If no release is present, it can be paired with a <strong>CISA electro-mechanical communal door lock</strong> (sold separately) for full functionality and added security.</p>

          <ul class="list-unstyled">
            <li><strong>What’s Included:</strong>
              <ul>
                <li>Aluminium exterior door station with 4 call buttons</li>
                <li>Four internal white gloss plastic audio handsets</li>
                <li>Mains power supply</li>
                <li>Wiring and installation included</li>
                <li>Connection to existing electric release (if suitable)</li>
              </ul>
            </li>

            <li><strong>Recommended Add-On:</strong> CISA Electro-Mechanical Lock (not included)</li>
            <li><strong>Finish:</strong> Brushed aluminium (external), white gloss plastic (internal)</li>
            <li><strong>Installation Area:</strong> Available in Birmingham and surrounding areas</li>
            <li><strong>Fitting:</strong> Professional installation included in the price</li>
          </ul>
        </div>

        <!-- Product Image -->
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Four-Button-Audio-Entry.jpg" class="img-fluid mb-3" alt="Four Button Audio Entry System" style="max-height: 350px; object-fit: contain;">

          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Four-Button-Audio-Entry.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Four-Button-Audio-Entry1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
