...
<head>
    ...
    <link rel="canonical" href="https://mrspeedy.co.uk/locksmith-locks/door-entry-systems/index.php" />
    ...
    <meta property="og:url" content="https://mrspeedy.co.uk/locksmith-locks/door-entry-systems/index.php" />
...
-->
    <section class="py-5">
        <div class="container">
            <h2 class="text-center mb-5">Explore Our Door Entry Systems </h2>
            <div class="row g-4">

                <?php
                $categories = [
                    ["name" => "Five-Button-Audio-Entry", "slug" => "Five-Button-Audio-Entry"],
                    ["name" => "Four-Button-Audio-Entry", "slug" => "Four-Button-Audio-Entry"],
                    ["name" => "One-Button-Audio-Entry", "slug" => "One-Button-Audio-Entry"],
                    ["name" => "Six-Button-Audio-Entry", "slug" => "Six-Button-Audio-Entry"],
                    ["name" => "Three-Button-Audio-Entry", "slug" => "Three-Button-Audio-Entry"],
                    ["name" => "Two-Button-Audio-Entry", "slug" => "Two-Button-Audio-Entry"],

                ];

                foreach ($categories as $cat):
                    $img = "https://mrspeedy.co.uk/assets/img/locks/" . $cat['slug'] . ".jpg";
                    $link = "https://mrspeedy.co.uk/locksmith-locks/door-entry-systems/" . $cat['slug'] . ".php";
                ?>
