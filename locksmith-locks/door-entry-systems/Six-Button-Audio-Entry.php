...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">Six Button Audio Entry System</h1>

      <!-- Two Columns Layout -->
      <div class="row align-items-center">
        <!-- Product Details -->
        <div class="col-md-7 order-2 order-md-1">
          <p>The <strong>Videx Six Button Audio Entry System</strong> is a professional-grade access control solution tailored for small residential blocks, converted properties, or commercial buildings with up to six separate units. Videx is a trusted name in door entry technology, offering reliable and stylish systems for both homes and businesses.</p>

          <p>This package includes a robust aluminium exterior door station with six call buttons, six internal white gloss handsets, a mains power transformer, and all necessary wiring. Where a previous system exists, the cabling is tested and reused where possible to maintain a clean installation and reduce costs.</p>

          <p>Connection to an existing electric strike is included (subject to compatibility). For systems without one, we recommend pairing this system with the <strong>CISA electro-mechanical communal door lock</strong> (available separately).</p>

          <ul class="list-unstyled">
            <li><strong>What’s Included:</strong>
              <ul>
                <li>Weather-resistant door station with 6 call buttons</li>
                <li>Six internal white gloss audio handsets</li>
                <li>Mains power supply</li>
                <li>All wiring, new or reused after inspection</li>
                <li>Connection to electric strike where compatible</li>
                <li>Full professional installation included</li>
              </ul>
            </li>

            <li><strong>Recommended Add-On:</strong> CISA Electro-Mechanical Lock (not included)</li>
            <li><strong>Finish:</strong> Brushed aluminium door station, white gloss handsets</li>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Six-Button-Audio-Entry.jpg" class="img-fluid mb-3" alt="Six Button Audio Entry System" style="max-height: 350px; object-fit: contain;">

          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Six-Button-Audio-Entry.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Six-Button-Audio-Entry1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
