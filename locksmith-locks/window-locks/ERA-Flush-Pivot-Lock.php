...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">ERA Flush Pivot Lock</h1>

      <!-- Two Columns Layout -->
      <div class="row align-items-center">
        <!-- Product Details -->
        <div class="col-md-7 order-2 order-md-1">
          <p>The ERA Flush Pivot Lock is made specially for flush framed windows. It enhances your security on timber windows, with a hardened hook bolt that deadlocks into the box keep.</p>

          <ul class="list-unstyled">
            <li><strong>Features:</strong>
              <ul>
                <li>Hookbolt deadlocks into box keep</li>
                <li>Key required to lock and unlock</li>
                <li>Supplied with thief-deterrent clutch-head screws</li>
                <li>Durable white gloss finish</li>
              </ul>
            </li>

            <li><strong>Keys Supplied:</strong> 1 key supplied per lock</li>
          </ul>
        </div>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <!-- Imaginea principală -->
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/ERA-Flush-Pivot-Lock.jpg" class="img-fluid mb-3" alt="ERA Flush Pivot Lock" style="max-height: 350px; object-fit: contain;">

          <!-- Galerie imagini mici -->
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/ERA-Flush-Pivot-Lock.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/ERA-Flush-Pivot-Lock1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
