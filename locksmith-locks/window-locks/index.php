...
-->
    <section class="py-5">
        <div class="container">
            <h2 class="text-center mb-5">Explore Our Window Locks</h2>
            <div class="row g-4">

                <?php
                $categories = [
                    ["name" => "ERA Flush Pivot Lock", "slug" => "ERA-Flush-Pivot-Lock"],
                    ["name" => "Yale Window Locks", "slug" => "Yale-8K101-Window-Lock"],
                    ["name" => "Sash Window Locks", "slug" => "Sash-Window-Locks"],
                    ["name" => "ERA-Metal-Window-Lock", "slug" => "ERA-Metal-Window-Lock"],
                    ["name" => "ERA-Snaplock-Metal-Window", "slug" => "ERA-Snaplock-Metal-Window"],
                    ["name" => "Ingersoll-CM67-Window-Lock", "slug" => "Ingersoll-CM67-Window-Lock"],
                    ["name" => "Ingersoll-FM68-Window-Lock", "slug" => "Ingersoll-FM68-Window-Lock"],
                    ["name" => "PVCu-Window-Bolt", "slug" => "PVCu-Window-Bolt"],
                    ["name" => "Yale-8K106-Window-Lock", "slug" => "Yale-8K106-Window-Lock"],
