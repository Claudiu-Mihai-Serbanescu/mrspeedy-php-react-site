...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">Yale 8K106 Window Lock</h1>

      <!-- Two Columns Layout -->
      <div class="row align-items-center">
        <!-- Product Details -->
        <div class="col-md-7 order-2 order-md-1">
          <p>The Yale 8K106 Window Lock is a reliable and easy-to-use security solution for timber casement windows. Designed to enhance the security of your home, this surface-fixed lock is key-operated and meets common insurance requirements.</p>

          <ul class="list-unstyled">
            <li><strong>Features:</strong>
              <ul>
                <li>Ideal for outward opening timber casement windows</li>
                <li>Surface-fixed design with strong holding power</li>
                <li>Lock engages around a fixed frame staple using the key</li>
                <li>Helps pull window tight to the frame, reducing drafts</li>
                <li>Durable white finish for a clean and discreet appearance</li>
                <li>Key operated – insurance company compliant</li>
              </ul>
            </li>

            <li><strong>Keys Supplied:</strong> 1 key included (extra keys available for £4 each)</li>
          </ul>
        </div>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <!-- Main Image -->
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Yale-8K106-Window-Lock.jpg" class="img-fluid mb-3" alt="Yale 8K106 Window Lock" style="max-height: 350px; object-fit: contain;">

          <!-- Thumbnail Gallery -->
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-8K106-Window-Lock.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-8K106-Window-Lock1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
