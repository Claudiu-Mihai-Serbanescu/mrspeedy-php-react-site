...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <h1 class="text-center">ERA Snaplock for Metal Windows</h1>
      <div class="row align-items-center">
        <div class="col-md-7 order-2 order-md-1">
          <p>The ERA Snaplock is specifically designed to enhance the security of metal windows. It automatically locks when the window is closed and can only be opened using the supplied key, making it ideal for both home and office environments.</p>
          <ul class="list-unstyled">
            <li><strong>Features:</strong>
              <ul>
                <li>Automatic locking on window closure</li>
                <li>Designed for metal casement windows</li>
                <li>Push-to-lock, key-to-unlock operation</li>
                <li>White or silver finish options available</li>
                <li>Surface-fixed for quick installation</li>
              </ul>
            </li>
            <li><strong>Keys Supplied:</strong> 1 key included (extra keys £4 each)</li>
          </ul>
        </div>
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/ERA-Snaplock-Metal-Window.jpg" class="img-fluid mb-3" alt="ERA Snaplock Metal Window Lock" style="max-height: 350px; object-fit: contain;">
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/ERA-Snaplock-Metal-Window.jpg" class="img-thumbnail gallery-thumb" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/ERA-Snaplock-Metal-Window1.jpg" class="img-thumbnail gallery-thumb" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
