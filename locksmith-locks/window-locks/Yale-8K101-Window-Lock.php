...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">Yale (formerly Chubb) 8K101 Window Lock</h1>

      <!-- Two Columns Layout -->
      <div class="row align-items-center">
        <!-- Product Details -->
        <div class="col-md-7 order-2 order-md-1">
          <p>The Yale 8K101 window lock is an easy to use, key operated window lock, as required by most insurance companies. It is compatible with a wide variety of modern and traditional period window types, as found on properties in and around London.</p>

          <ul class="list-unstyled">
            <li><strong>Features:</strong>
              <ul>
                <li>Flexible, key operated window locks suitable for most hinged timber casement windows</li>
                <li>Lock is surface fixed onto the window section and is locked around the frame fixed staple by use of the key</li>
                <li>A clenching action helps to pull the window to the frame to reduce draughts</li>
                <li>Durable white finish</li>
              </ul>
            </li>

            <li><strong>Keys Supplied:</strong> 1 key supplied per room (extra keys £4 each)</li>
          </ul>
        </div>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <!-- Imaginea principală -->
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Yale-8K101-Window-Lock.jpg" class="img-fluid mb-3" alt="Yale 8K101 Window Lock" style="max-height: 350px; object-fit: contain;">

          <!-- Galerie imagini mici -->
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-8K101-Window-Lock.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-8K101-Window-Lock1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
