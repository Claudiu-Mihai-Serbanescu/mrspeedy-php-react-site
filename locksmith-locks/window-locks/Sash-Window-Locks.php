...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">Sash Window Locks</h1>

      <!-- Two Columns Layout -->
      <div class="row align-items-center">
        <!-- Product Details -->
        <div class="col-md-7 order-2 order-md-1">
          <p>Sliding sash locks are very vulnerable to forced entry, and are often very insecure as they are only fitted with sash fasteners – which are not locks!</p>

          <p>Sash stops screw into the wooden window, and secure the window to insurance standard. They are simple to operate, using the supplied key, and are the ideal solution to securing your sash windows.</p>

          <p>To complement this lock we strongly recommend the <strong>'Sash Fastener'</strong> for extra security for your windows.</p>

          <ul class="list-unstyled">
            <li><strong>Features:</strong>
              <ul>
                <li>Price includes fitting (two locks per window)</li>
                <li>Screw-in bolt secures sliding sash window</li>
                <li>Two locking positions – fully closed or partially open for ventilation</li>
                <li>Can be easily removed to permit full opening</li>
                <li>Key operated, as required by insurance companies</li>
                <li>Fitted by our London Locksmith team anywhere in the London M25 area</li>
              </ul>
            </li>
          </ul>
        </div>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <!-- Imaginea principală -->
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Sash-Window-Locks.jpg" class="img-fluid mb-3" alt="Sash Window Locks" style="max-height: 350px; object-fit: contain;">

          <!-- Galerie imagini mici -->
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Sash-Window-Locks.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Sash-Window-Locks1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
