...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <h1 class="text-center">Ingersoll FM68 Window Lock</h1>
      <div class="row align-items-center">
        <div class="col-md-7 order-2 order-md-1">
          <p>The Ingersoll FM68 is a flush-mounted locking system for timber windows. With its strong internal mechanism and concealed fixing, it provides excellent security without compromising on appearance.</p>
          <ul class="list-unstyled">
            <li><strong>Features:</strong>
              <ul>
                <li>Flush-mounted lock ideal for traditional timber frames</li>
                <li>Concealed screws for added security</li>
                <li>Simple turn of key locks the mechanism</li>
                <li>White finish blends with most window styles</li>
                <li>Supplied with security fixings and key</li>
              </ul>
            </li>
            <li><strong>Keys Supplied:</strong> 1 key included (extra keys £6 each)</li>
          </ul>
        </div>
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Ingersoll-FM68-Window-Lock.jpg" class="img-fluid mb-3" alt="Ingersoll FM68 Window Lock" style="max-height: 350px; object-fit: contain;">
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Ingersoll-FM68-Window-Lock.jpg" class="img-thumbnail gallery-thumb" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Ingersoll-FM68-Window-Lock1.jpg" class="img-thumbnail gallery-thumb" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
