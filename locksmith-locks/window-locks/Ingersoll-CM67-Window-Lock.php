...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <h1 class="text-center">Ingersoll CM67 Window Lock</h1>
      <div class="row align-items-center">
        <div class="col-md-7 order-2 order-md-1">
          <p>The Ingersoll CM67 is a premium-quality window lock designed for outward opening timber casement windows. Its compact size and high-strength construction make it ideal for both residential and commercial settings where security is a priority.</p>
          <ul class="list-unstyled">
            <li><strong>Features:</strong>
              <ul>
                <li>High-security lock for timber casement windows</li>
                <li>Key operated for added protection</li>
                <li>Surface-mounted for easy installation</li>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Ingersoll-CM67-Window-Lock.jpg" class="img-fluid mb-3" alt="Ingersoll CM67 Window Lock" style="max-height: 350px; object-fit: contain;">
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Ingersoll-CM67-Window-Lock.jpg" class="img-thumbnail gallery-thumb" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Ingersoll-CM67-Window-Lock1.jpg" class="img-thumbnail gallery-thumb" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
