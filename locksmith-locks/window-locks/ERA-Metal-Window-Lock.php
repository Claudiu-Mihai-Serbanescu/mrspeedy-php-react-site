...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <h1 class="text-center">ERA Metal Window Lock</h1>
      <div class="row align-items-center">
        <div class="col-md-7 order-2 order-md-1">
          <p>The ERA Metal Window Lock is a cost-effective way to secure your metal casement windows. This easy-to-fit lock bolts through the frame and uses a removable key to prevent unauthorized access.</p>
          <ul class="list-unstyled">
            <li><strong>Features:</strong>
              <ul>
                <li>Engineered for metal-framed windows</li>
                <li>Bolt-through fixing for enhanced strength</li>
                <li>Removable key operation for added security</li>
                <li>Compact design with a clean finish</li>
                <li>Surface-fixed for straightforward installation</li>
              </ul>
            </li>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/ERA-Metal-Window-Lock.jpg" class="img-fluid mb-3" alt="ERA Metal Window Lock" style="max-height: 350px; object-fit: contain;">
          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/ERA-Metal-Window-Lock.jpg" class="img-thumbnail gallery-thumb" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/ERA-Metal-Window-Lock1.jpg" class="img-thumbnail gallery-thumb" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
