...
-->
    <section class="py-5">
        <div class="container">
            <h2 class="text-center mb-5">Explore Our Burglar Bars, Security Grilles & More</h2>
            <div class="row g-4">

                <?php
                $categories = [
                    ["name" => "Burglar-Bar-Gate", "slug" => "Burglar-Bar-Gate"],
                    ["name" => "Collapsible-Grille", "slug" => "Collapsible-Grille"],
                    ["name" => "Diamond-Mesh-Security-Grille", "slug" => "Diamond-Mesh-Security-Grille"],
                    ["name" => "Window-Bars", "slug" => "Window-Bars"],

                ];

                foreach ($categories as $cat):
                    $img = "https://mrspeedy.co.uk/assets/img/locks/" . $cat['slug'] . ".jpg";
                    $link = "https://mrspeedy.co.uk/locksmith-locks/burglar-bars-grilles/" . $cat['slug'] . ".php";
                ?>
