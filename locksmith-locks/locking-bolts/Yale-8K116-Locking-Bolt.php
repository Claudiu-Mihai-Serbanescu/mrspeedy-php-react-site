...
<body id="page-top">
  ...
  <div class="product-section" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="container">
      <!-- Product Title -->
      <h1 class="text-center">Yale (formerly Chubb) 8K116 Locking Bolt</h1>

      <!-- Two Columns Layout -->
      <div class="row align-items-center">
        <!-- Product Details -->
        <div class="col-md-7 order-2 order-md-1">
          <p>The Yale 8K116 is a robust and easy-to-use surface-mounted security bolt designed to improve the protection of a wide range of doors. Ideal for securing rear entry points, the 8K116 complies with common insurance requirements that recommend key-operated locking bolts at both the top and bottom of rear doors.</p>

          <p>This locking bolt is suitable for a variety of door types, including aluminium patio doors, wooden back doors, conventional hinged doors, and sliding doors. Unlike traditional mortice bolts, the 8K116 can be installed without the need to remove substantial timber or unhang rebated doors—making it a practical, high-security upgrade with minimal disruption.</p>

          <p>The 8K116 is versatile and can be fitted either horizontally or vertically depending on the door configuration. Its steel locking bar provides strong resistance to forced entry, while the supplied keys ensure safe and simple operation.</p>
          ...
          <ul class="list-unstyled">
            ...
            <li><strong>Features:</strong>
              <ul>
                <li>Surface-mounted bolt for improved door security</li>
                <li>Ideal for aluminium sliding doors, timber doors, and hinged back doors</li>
                <li>Manual steel bolt locks securely into frame using key</li>
                <li>Works on single or double doors</li>
                <li>Can be installed horizontally or vertically</li>
                <li>Key-operated mechanism complies with insurance standards</li>
                <li>Easy to install without removing large sections of the door</li>
                <li>Supplied with all necessary fixings</li>
              </ul>
            </li>

            <li><strong>Keys Supplied:</strong> 2 keys included (extra keys £5 each)</li>
        ...
        <div class="col-md-5 order-1 order-md-2 text-center mb-4 mb-md-0">
          <img id="mainImage" src="https://mrspeedy.co.uk/assets/img/locks/Yale-8K116-Locking-Bolt.jpg" class="img-fluid mb-3" alt="Yale 8K116 Locking Bolt" style="max-height: 350px; object-fit: contain;">

          <div class="d-flex justify-content-center gap-2 flex-wrap">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-8K116-Locking-Bolt.jpg" class="img-thumbnail gallery-thumb" alt="thumb 1" style="width: 70px; cursor: pointer;">
            <img src="https://mrspeedy.co.uk/assets/img/locks/Yale-8K116-Locking-Bolt1.jpg" class="img-thumbnail gallery-thumb" alt="thumb 2" style="width: 70px; cursor: pointer;">
          </div>
        </div>
      </div>
    </div>
