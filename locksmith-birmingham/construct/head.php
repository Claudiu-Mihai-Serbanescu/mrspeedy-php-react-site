...
<head>
    ...
    <meta http-equiv="last-modified"
        content="<?= gmdate('D, d M Y H:i:s', strtotime($val($seo, 'last_modified')) ?: time()) . ' GMT' ?>" />
    ...
    <meta property="og:title"
        content="<?= htmlspecialchars($val($seo, 'og_title', $val($seo, 'title')), ENT_QUOTES) ?>" />
    <meta property="og:description"
        content="<?= htmlspecialchars($val($seo, 'og_description', $val($seo, 'description')), ENT_QUOTES) ?>" />
    ...
    <meta name="twitter:title"
        content="<?= htmlspecialchars($val($seo, 'twitter_title', $val($seo, 'title')), ENT_QUOTES) ?>" />
    <meta name="twitter:description"
        content="<?= htmlspecialchars($val($seo, 'twitter_description', $val($seo, 'description')), ENT_QUOTES) ?>" />
    <meta name="twitter:image"
        content="<?= htmlspecialchars($val($seo, 'twitter_image', $val($seo, 'og_image')), ENT_QUOTES) ?>" />
