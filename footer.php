<footer class="site-footer" role="contentinfo" aria-labelledby="footer-title" itemscope itemtype="https://schema.org/Locksmith">
        ...
        <div class="sf-top">
            ...
            <div class="sf-col sf-brand" aria-label="Company details">
                <a href="/" class="sf-logo" itemprop="url">
                    <img src="<?= $BASE ?>/assets/img/navbar-logo2.svg" width="168" height="40" alt="Mr Speedy Locksmith" itemprop="logo">
                </a>
                ...
                <ul class="sf-hours" aria-label="Opening hours" itemprop="openingHoursSpecification" itemscope itemtype="https://schema.org/OpeningHoursSpecification">
                    <li>
                        <meta itemprop="dayOfWeek" content="Monday"><span>Mon–Sun</span> <time itemprop="opens" datetime="00:00">24/7</time>
                    </li>
                </ul>
            </div>
            ...
            <nav class="sf-col" aria-label="Popular services">
                ...
                <ul class="sf-list">
                    <li><a href="/locksmith-birmingham/Non-Destructive-Entry-%26-Snapped-Key-Extraction.php">Non-destructive entry</a></li>
                    <li><a href="/locksmith-birmingham/lock-replacement-and-installation.php">Lock replacement &amp; installation</a></li>
                    <li><a href="/locksmith-birmingham/burglary-repairs-property-boarding.php">Burglary repairs &amp; boarding</a></li>
                    <li><a href="/locksmith-birmingham/upvc-repairs.php">uPVC door &amp; window repairs</a></li>
                    <li><a href="/locksmith-birmingham/Fire-Doors-Roller-Shutters-Gates-Garage-Doors.php">Fire/garage doors &amp; shutters</a></li>
                </ul>
            </nav>
            ...
            <section class="sf-col sf-social" aria-label="Social and trust">
                ...
                <p class="sf-social-row">
                    <a class="btn btn-dark btn-social" href="https://www.facebook.com/mrspeedylocksmithbirmingham" target="_blank" rel="me noopener" aria-label="Facebook">
                        <i class="fab fa-facebook-f" aria-hidden="true"></i>
                    </a>
                    <a class="btn btn-dark btn-social" href="https://wa.me/447846716954" target="_blank" rel="noopener" aria-label="WhatsApp">
                        <i class="fab fa-whatsapp" aria-hidden="true"></i>
                    </a>
                </p>
                <p class="sf-meta"><span itemprop="priceRange">££</span> • <span>DBS checked</span> • <span>Fully insured</span></p>
            </section>
        </div>
...
<div class="floating-actions">
    <a href="https://wa.me/+447846716954" class="float" target="_blank" style="text-decoration: none">
        <i class="fa-brands fa-whatsapp my-float m-2" style="font-size: 2rem"></i>
